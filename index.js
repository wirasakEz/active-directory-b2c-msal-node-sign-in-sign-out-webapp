...
app.get("/signin-oidc-b2c", (req, res) => {
    ...
    confidentialClientApplication
      ...
      .then((response) => {
        ...
        res.render("signin", {
          ...
          name: response.account.idTokenClaims.name,
    ...
    if (req.query.error) {
      ...
      if (JSON.stringify(req.query.error_description).includes("AADB2C90091")) {
        ...
        res.render("signin", {
          ...
          name: req.session.sessionParams.user.idTokenClaims.name,
...
app.listen(process.env.SERVER_PORT, () => {
  console.log(
    `Msal Node Auth Code Sample app listening on port !` +
